...
public interface CustomerAppointmentRepo extends JpaRepository<CustomerAppointmentDomain, Long>{
	...
	Integer findMaxVisitByCustomerId(@Param("id") Long id, @Param("typeOfAppointment") AppointmentType typeOfAppointment);
	
	Optional<List<CustomerAppointmentDomain>> findByIsVisitDoneIgnoreCase(String isVisitDone);
}
